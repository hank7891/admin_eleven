    ...
    <div class="content-wrapper">
        <div class="p-6 lg:p-10 space-y-8">
            ...
            <div class="flex flex-col md:flex-row md:items-end justify-between gap-4">
                <div>
                    <x-breadcrumb :items="[['label' => '首頁', 'url' => 'admin/'], ['label' => '登入日誌']]" />
                ...
                <div class="bg-surface-container-lowest rounded-xl shadow-[0_24px_40px_-4px_rgba(23,28,31,0.06)] p-6">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div class="space-y-2">
                            ...
                            <input type="text" name="operator_keyword" placeholder="模糊搜尋..." value="{{ $filters['operator_keyword'] ?? '' }}"
                    ...
                    <div class="flex justify-end gap-3 mt-8 pt-6 border-t border-outline-variant/20">
                        <a href="{{ asset('admin/admin.login-log/list') }}" class="px-6 py-2.5 text-outline hover:text-on-surface font-medium text-[0.875rem] transition-colors no-underline">
                            清除條件
                        </a>
