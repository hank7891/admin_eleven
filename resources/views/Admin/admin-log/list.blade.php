                        ...
                        <form method="GET" action="{{ asset('admin/admin.log/list') }}">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <a href="{{ asset('admin/admin.log/list') }}" class="btn btn-default ml-2">
                            ...
                            <table id="logTable" class="table table-bordered table-hover">
                                ...
                                @foreach ($data as $key => $row)
                                    <tr>
                                        <td>{{ $key + 1 }}</td>
                                        <td>
                                            <a class="btn btn-primary btn-sm" href="{{ asset('admin/admin.log/detail/' . $row['id']) }}">詳情</a>
                                        </td>
                                        <td>{{ $row['id'] }}</td>
