        ...
        <div class="p-6 lg:p-10 space-y-8">
            ...
            <div class="flex flex-col md:flex-row md:items-end justify-between gap-4">
                ...
                <div class="flex gap-3">
                    <a href="{{ asset('admin/admin.menu/edit/0') }}" class="btn-primary px-6 py-2.5 rounded-xl flex items-center gap-2 hover:scale-105 active:scale-95 transition-all duration-200 no-underline">
